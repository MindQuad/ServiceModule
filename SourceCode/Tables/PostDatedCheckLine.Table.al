table 50098 "Post Dated Check Line"
{
    // WINPDC : Added New Option on Status 'Revoke Cheque'.
    // WINPDC : Added New field 'Cheque Dropped'.
    // WINPDC : Added New field 'No. Series' & Created new function for No. series added code on Account No. on validate
    // WINPDC : Added Code on Account No Field to select cash entries.
    // WINPDC : Added Code on Amount Field to select cash entries.
    // WINPDC : Added Code on Batch Name field on Validate for cash entries selection.
    // WINPDC : Added Code on Batch Name field on lookup for cash entries selection.

    Caption = 'Post Dated Check Line';
    //DrillDownPageID = 28091;
    //LookupPageID = 28091;
    ...
    fields
    {
        ...
        field(10; "Account No."; Code[20])
        {
            ...
            begin
                ...
                IF "Document No." = '' THEN BEGIN
                    GeneralLedgerSetup.GET;
                    NoSeriesMgt.InitSeries(GeneralLedgerSetup."PDC Document Nos.", xRec."No. Series", 0D, "Document No.", "No. Series");
                END;
                //WINPDC--
            end;
        }
        ...
        //Win593++
        field(50040; "Document Type"; Enum "Sales Document Type")
        {
        }
        //Win593--
    ...
    {
        //Win593++
        key(Key1; "Template Name", "Batch Name", "Account Type", "Account No.", "Customer No.", "Line Number", "Contract No.", "Document Type", "Document No.")
        {
            Clustered = true;
    ...
    /* [Scope('Internal')] */
    procedure SetGenJnlLine(var PostDatedCheck: Record 50098)
    begin
        //Win513++
    ...
    /* [Scope('Internal')] */
    procedure AssistEdit(OldPostDatedCheckLine: Record 50098): Boolean
    begin
        //WINPDC++
        GeneralLedgerSetup.GET;
        TestNoSeries;
    ...
    begin
        //WINPDC++
        GeneralLedgerSetup.GET;
        GeneralLedgerSetup.TESTFIELD(GeneralLedgerSetup."PDC Document Nos.");
        //WINPDC--
    end;
    ...
    begin
        //WINPDC++
        GeneralLedgerSetup.GET;
        EXIT(GeneralLedgerSetup."PDC Document Nos.");
        //WINPDC--
    end;
}
