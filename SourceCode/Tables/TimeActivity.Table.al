table 50124 "Time Activity"
{
    Caption = 'Time Activity';
    /* DrillDownPageID = 33055786;
    LookupPageID = 33055786; */
    ...
    fields
    {
        ...
        {
            CalcFormula = Sum("Employee Absence"."Quantity (Base)" WHERE("Cause of Absence Code" = FIELD(Code1),
        ...
        field(114; "Statutory Reporting Abs. Code"; Code[20])
        {
            Caption = 'Statutory Reporting Abs. Code';
