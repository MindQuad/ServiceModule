report 50001 "Rent Reciepts"
{
    DefaultLayout = RDLC;
    RDLCLayout = 'SourceCode/Report/RentReciepts.rdl';
    PreviewMode = PrintLayout;
    Caption = 'Rent Reciepts';
    ApplicationArea = All;
    ...
    dataset
    {
        dataitem("Service Contract Header"; "Service Contract Header")
        {
            ...
            column(CountryRegionCode_ServiceContractHeader; "Country/Region Code")
            {
            }
            ...
            column(TenantName_ServiceContractHeader; "Tenant Name")
            {
            }
            column(ServContractAccGrCode_ServiceContractHeader; "Serv. Contract Acc. Gr. Code")
            {
            }
            ...
            dataitem("Service Charges"; "Service Charges")
            {
                ...
                DataItemTableView = WHERE("Charge Code" = Filter(<> 'VAT'));
                ...
                column(ModeofPayment_ServiceCharges; "Mode of Payment")
                {
                }
                column(OtherAmt; OtherAmt)
                {
            ...
            begin
                ...
                if "Service Contract Header"."Currency Code" = '' then
                    CurrencyGLS := RecGenLedgerSetup."LCY Code"
                else
                    CurrencyGLS := "Service Contract Header"."Currency Code";


                AmountVendor := Round("Service Contract Header"."Annual Amount", 0.01);
