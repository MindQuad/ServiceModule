report 50012 "Lease Application Residential1"
{
    DefaultLayout = RDLC;
    RDLCLayout = './LeaseApplicationResidential1.rdl';
    ...
    dataset
    {
        dataitem("Service Contract Header"; "Service Contract Header")
        {
            ...
            column(Mobile; CompInfo."Phone No. 2")
            {
            }
            ...
            column(MaritalStatus; RecCust."Marital Status")
            {
            }
            column(MobileNo; RecCust."Mobile Phone No.")
            {
            }
            ...
            column(PhoneNo_ServiceContractHeader; RecCust."Phone No.")
            {
            }
                ...
                IF ServiceCharges.FINDSET THEN
                    REPEAT
                        ...
                        ELSE
                            ...
                            ELSE
                                IF ServiceCharges."Charge Code" = 'DEWA' THEN
                                    Dewa := ServiceCharges."Charge Amount"
                                ELSE
