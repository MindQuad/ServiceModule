report 55808 "Employee Detail Trial Balance"
{
    DefaultLayout = RDLC;
    RDLCLayout = './EmployeeDetailTrialBalance.rdl';
    Caption = 'Employee Detail Trial Balance';
    ...
    dataset
    {
        dataitem(Employee; Employee)
        {
            ...
            column(Vendor_TABLECAPTION__________Filter; Employee.TABLECAPTION + ': ' + Filter)
            {
            }
            ...
            column(Vendor_Name; "First Name" + ' ' + "Middle Name" + ' ' + "Last Name")
            {
            }
            ...
            dataitem(Date; Date)
            {
                ...
                dataitem("Detailed Vendor Ledg. Entry"; "Detailed Employee Ledger Entry")
                {
                    ...
                    DataItemTableView = SORTING("Employee No.", "Posting Date", "Entry Type", "Initial Entry Global Dim. 1", "Initial Entry Global Dim. 2", "Currency Code")
                    ...
                    column(OriginalLedgerEntry__External_Document_No__; OriginalLedgerEntry."Document No.")
                    {
                    }
                    ...
                    column(Detailed_Vendor_Ledg__Entry_Vendor_No_; "Employee No.")
                    {
                    }
                    ...
                    begin
                        ...
                        OriginalLedgerEntry.GET("Employee Ledger Entry No.");
            ...
            begin
                ...
                VendLedgEntry.SETRANGE("Employee No.", "No.");
    ...
    var
        ...
        Text008: Label 'Total';
        VendLedgEntry: Record "Detailed Employee Ledger Entry";
        OriginalLedgerEntry: Record "Employee Ledger Entry";
        VendLedgEntry2: Record "Detailed Employee Ledger Entry";
        ...
        Vendor_Detail_Trial_BalanceCaptionLbl: Label 'Employee Statement';
