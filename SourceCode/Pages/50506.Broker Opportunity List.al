page 50506 "Broker Opportunity List"
{
    AdditionalSearchTerms = 'prospects';
    ApplicationArea = RelationshipMgmt;
    Caption = 'Broker Opportunities';
    CardPageID = "Broker Opportunity Card";
    DataCaptionExpression = Caption;
    Editable = false;
    PageType = List;
    SourceTable = Opportunity;
    SourceTableView = where("From Borker" = const(true));
    UsageCategory = Lists;
    ...
    var
        ...
        CRMCouplingManagement: Codeunit "CRM Coupling Management";
    begin
        Rec.CalcFields(Rec."Current Sales Cycle Stage");
        CurrSalesCycleStage := '';
    ...
    begin
        ...
        //with Contact do
        //Win513--
        exit(BuildCaption(CaptionText, Contact, Filter, Contact.FieldNo("No."), Contact.FieldNo("Name")));
    end;
